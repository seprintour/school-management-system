...
<head>
	...
	<meta name="author" content="Optimum Linkup Universal Concepts" />
	
	<title>Install | Optimum Linkup School Management System</title>
...
<div class="row" style="margin-top: 30px;">
		...
		<div class="col-md-4">
			<div class="panel panel-primary" style="background-color:rgba(255, 255, 255, 0);border-color: rgba(235, 235, 235, 0.14);">
		        <div class="x_title" style="background-color:rgba(255, 255, 255, 0.16);border-color: rgba(204, 204, 204, 0.08);">
