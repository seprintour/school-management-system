	...
	<div class="col-md-12">
    	...
    	<!------CONTROL TABS END------>
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open(base_url() . 'index.php?admin/manage_marks');?>
                <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                	...
                	<tr>
                        ...
                        <td>
                        	<select name="class_id" class="form-control"  onchange="show_students(this.value)"  style="float:left;">
        ...
        <button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>&nbsp;<?php echo get_phrase('manage_marks'); ?></button>
                ...
                <table class="table table-bordered" >
                    <thead>
                        <tr>
                            ...
                            <td><?php echo get_phrase('class score');?></td>
                ...
                <td>
                  ...
                  <h4 id="error_message" style="color: red;display: none;margin-left: 50px;">Class Score must to be smaller than 30 and Exam Score must to be smaller than 70.</h4>
                  <center>
