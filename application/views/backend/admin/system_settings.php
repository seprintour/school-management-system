    ...
    <div class="col-md-6">
        ...
        <div class="x_panel" >
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select name="running_session" class="form-control ">
                            <option value=""><?php echo $this->db->get_where('settings', array('type' => 'session'))->row()->description; ?></option>
                ...
                <div class="form-group">
                    <label  class="col-sm-3 control-label"><?php echo get_phrase('system_footer'); ?></label>
                    <div class="col-sm-9">
