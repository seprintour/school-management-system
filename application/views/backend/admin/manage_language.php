...
<div class="table-responsive">
    ...
    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete_language');?>" class="btn btn-danger btn-sm btn-icon icon-left" onclick="return confirm('Delete Language ?');">
