            ...
            <?php echo form_open(base_url() . 'index.php?admin/id_card/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="hostel" id="hostel_id" class="form-control" style="width: 250px;">
                        ...
                        <!-- </div> -->
                        <!-- <input type='file' onchange="readURL(this);" value="Image for hostel's Signature" /> -->
                        <!-- <div class="row">
                            <div class="col-md-4">
            ...
            <div class="side">
                ...
                <div class="detail-content" style="width: 320px;height: 20px;font-size: 12px;">
                    <div style="padding-right: 7px;height: 30px;">
                        <label>hostel's signature :</label>
                        <img id="hostel_sign" src="uploads/sign.png" alt="" style="margin-top: -2px;" />
                    </div>
                    <div style="padding-right: 7px;height: 30px;">
...
function show_photo() {
    if (times) {
        var select = $('#hostel_id');
        var value = select[0].value;
        var photo = document.getElementById("photo");
        photo.src = "uploads/hostel_image/"+value+".jpg";
        times = -1;
    }
    times++;
}
