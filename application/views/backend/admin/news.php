...
<div class="x_panel" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('news_information_page'); ?>
					</div>
					</div>
		...
		<div class="tab-content">
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary pull-right" role="menu">
                                    ...
                                    <!-- EDITING LINK -->
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_news/<?php echo $row['news_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/news/delete/<?php echo $row['news_id'];?>');">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/news/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
