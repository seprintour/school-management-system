		...
		<ul class="nav nav-tabs bordered">
			<li class="active">
            	<a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
					<?php echo get_phrase('help_desk_list');?>
                    	</a></li>
			<li>
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary pull-right" role="menu">
                                    ...
                                    <!-- EDITING LINK -->
                                    <li>
                                 <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_help_desk/<?php echo $row['helpdesk_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/help_desk/delete/<?php echo $row['helpdesk_id'];?>');">
                        ...
                        <div class="padded">
                           ...
                           <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-success btn-sm btn-icon icon-left"><i class="fa fa-plus"></i><?php echo get_phrase('add_help_link');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
