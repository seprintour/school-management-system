                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary pull-right" role="menu">
                                    ...
                                    <!-- EDITING LINK -->
                                    <li>
                                 <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_club/<?php echo $row['club_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/club/delete/<?php echo $row['club_id'];?>');">
